      ...
      <main id="main-content" className="main-premium pb-24 pt-28 md:pt-32">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <Link
            ...
            className="group hover-lift card-glow-border mt-14 grid overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,37,0.84),rgba(10,16,25,0.96))] shadow-[0_18px_50px_rgba(0,0,0,0.14)] transition hover:border-white/14 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 md:grid-cols-2"
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6 pt-4">
                  <div className="flex flex-wrap items-center gap-2 text-xs text-slate-400">
                    <span className="rounded-full border border-cyan-300/20 bg-cyan-400/[0.08] px-2.5 py-0.5 font-medium text-cyan-100">
                      {post.category}
                    </span>
                    <span className="inline-flex items-center gap-1">
                  ...
                  <span className="mt-auto inline-flex items-center gap-2 pt-4 text-sm font-medium text-cyan-200">
                    Leer artículo
                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
                  </span>
                </div>
