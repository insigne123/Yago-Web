    ...
    <div className="relative min-h-screen overflow-x-clip text-white">
      ...
      <main id="main-content" className="main-premium pb-24 pt-20 md:pt-24">
        <article className="mx-auto max-w-3xl px-4">
          ...
          <h1 className="mt-4 font-headline text-4xl font-semibold text-white md:text-5xl">Términos de uso</h1>
          <p className="mt-4 text-sm text-slate-300">Última actualización: 1 de septiembre de 2026.</p>

          <div className="mt-10 space-y-9 text-base leading-7 text-slate-300">
            <section>
              <h2 className="text-2xl font-semibold text-white">1. Alcance del sitio</h2>
              <p className="mt-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white">2. Uso permitido</h2>
              <p className="mt-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white">3. Información y resultados</h2>
              <p className="mt-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white">4. Sitios y servicios externos</h2>
              <p className="mt-3">
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                <a className="font-semibold text-sky-300 underline underline-offset-4" href={`mailto:${COMPANY.email}`}>
                  {COMPANY.email}
                </a>
