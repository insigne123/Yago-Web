              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.92),rgba(10,16,25,0.98))] p-1 shadow-[0_30px_100px_rgba(0,0,0,0.22)]">
                <Card className="relative overflow-hidden rounded-[1.75rem] border-white/8 bg-transparent shadow-none">
                  <CardHeader className="pb-5">
                    ...
                    <CardTitle className="mt-3 text-[2rem] leading-none text-white md:text-[2.35rem]">
                    ...
                    <div className="grid gap-4 xl:grid-cols-[0.88fr_1.12fr]">
                      <div className="rounded-[1.45rem] border border-white/10 bg-white/[0.04] p-4">
                        <div className="flex items-center justify-between gap-3">
                          <div>
                            <div className="text-xs uppercase tracking-[0.16em] text-slate-400">Documento escaneado</div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-[1.45rem] border border-white/10 bg-white/[0.04] p-4">
                          <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.16em] text-amber-100">
                            <FileJson2 className="h-4 w-4" aria-hidden="true" />
                            Datos listos para usar
                          </div>
                          <div className="mt-4 flex flex-wrap gap-2">
                            {OCR_PAGE.hero.previewTargets.map((target) => (
                              <span key={target} className="rounded-full border border-white/10 bg-black/20 px-3 py-2 text-xs uppercase tracking-[0.14em] text-slate-200">
                                {target}
                              </span>
                            ))}
                          </div>
              ...
              <Card className="overflow-hidden rounded-[2rem] border-white/10 bg-[linear-gradient(180deg,rgba(17,24,37,0.92),rgba(10,16,25,1))] shadow-[0_24px_90px_rgba(0,0,0,0.18)]">
                <CardContent className="grid gap-4 p-6 lg:grid-cols-[0.95fr_auto_1.05fr] lg:items-center">
                  <div className="rounded-[1.45rem] border border-white/10 bg-white/[0.04] p-5">
                    <div className="text-xs uppercase tracking-[0.16em] text-slate-400">{OCR_PAGE.solution.inputLabel}</div>
                  ...
                  <div className="rounded-[1.45rem] border border-white/10 bg-black/20 p-5">
                    <div className="text-xs uppercase tracking-[0.16em] text-slate-400">{OCR_PAGE.solution.outputLabel}</div>
                    <div className="mt-4 grid gap-3 text-sm text-slate-200">
        ...
        <SectionReveal as="div" surface="strong">
          <Section id="demo" className="z-10">
            <div className="mx-auto grid max-w-7xl gap-6 px-4 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
              <div>
                <p className="text-xs uppercase tracking-[0.22em] text-slate-400">Prueba o demo</p>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  <Button
                    asChild
                    size="lg"
                    className="rounded-full border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(223,234,255,0.92))] text-slate-950 transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(167,199,255,0.2)] active:scale-[0.98]"
                  >
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Button
                      asChild
                      variant="ghost"
                      className="rounded-full border border-white/10 bg-white/[0.04] text-slate-100 transition-colors hover:bg-white/[0.08]"
                    >
                      <a href={COMPANY.whatsappLink} target="_blank" rel="noreferrer">
