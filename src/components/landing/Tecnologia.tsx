      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <div className="hover-lift rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6">
              <div className="flex items-center justify-between gap-3">
                <div className="text-sm font-medium text-white">Herramientas y ecosistemas</div>
                <div className="text-xs text-slate-300">Ejemplos típicos</div>
              </div>
          ...
          <div className="lg:col-span-4">
            <div className="hover-lift rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6">
              ...
              <div className="mt-6 rounded-[1.25rem] border border-white/10 bg-white/5 p-4 text-xs leading-relaxed text-slate-300">
