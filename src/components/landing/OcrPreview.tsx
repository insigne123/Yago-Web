  ...
  return (
    <Section className="z-10" id="ocr-home">
      <div className="mx-auto max-w-7xl px-4">
        <div className="card-glow-border flex flex-col gap-6 overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(120deg,rgba(125,211,252,0.08),rgba(125,211,252,0.02))] p-6 md:flex-row md:items-center md:justify-between md:p-8">
          <div className="flex items-start gap-4">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl border border-sky-300/20 bg-sky-400/10 text-sky-300">
