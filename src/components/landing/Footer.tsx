  ...
  return (
    <footer className="relative pb-12 pt-6">
      <div className="mx-auto max-w-7xl px-4">
        <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#070b13] text-white shadow-[0_24px_90px_rgba(7,11,19,0.24)]">
          <div className="grid gap-8 px-6 py-8 md:grid-cols-12 md:px-8 md:py-10">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-slate-300">
                {footerLinks.map((link) => (
                  <Link
                    key={link.name}
                    href={link.href}
                    className="rounded-xl px-2 py-1 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                  >
                    {link.name}
                  </Link>
                ))}
            ...
            <div className="md:col-span-4">
              ...
              <div className="mt-4 grid gap-3 text-sm">
                <a
                  className="inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-slate-300 transition-colors hover:border-sky-200/30 hover:bg-white/10 hover:text-white"
