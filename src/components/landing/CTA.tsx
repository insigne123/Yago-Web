  ...
  return (
    <Section className="py-16" id="analisis">
      <div className="mx-auto max-w-5xl px-4">
        <div className="relative hover-lift overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-8 text-center">
          <div
            aria-hidden="true"
          ...
          <div className="relative">
            <p className="text-xs tracking-[0.22em] text-slate-300">PRIMER PASO</p>
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full border border-white/10 bg-white text-[#070b13] shadow-[0_14px_34px_rgba(5,11,19,0.24)]"
                >
                  <a href={PRIMARY_CTA.href} className="plausible-event-name=CTA+Agendar+Sesion plausible-event-location=cta_section">
                    {PRIMARY_CTA.label}
                  </a>
                </Button>
              <Button asChild size="lg" variant="ghost" className="rounded-full border border-white/10 bg-white/[0.04] text-white hover:bg-white/10">
                <a
