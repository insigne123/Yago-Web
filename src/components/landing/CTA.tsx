      ...
      <div className="mx-auto max-w-5xl px-4">
        <div className="relative hover-lift overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,37,0.9),rgba(10,16,25,0.98))] p-8 text-center">
          ...
          <div className="relative">
            <p className="text-xs tracking-[0.22em] text-slate-400">PRIMER PASO</p>
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(241,247,255,0.94))] text-slate-950 shadow-[0_14px_34px_rgba(5,11,19,0.24)]"
                >
