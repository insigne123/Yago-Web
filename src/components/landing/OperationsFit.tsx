    ...
    <Section className="z-10" id="fit-operacional">
      <div className="mx-auto grid max-w-7xl gap-6 px-4 xl:grid-cols-[0.96fr_1.04fr]">
        <div>
          ...
          <div className="mt-6 rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {pains.map((pain) => {
            ...
            return (
              <div
                key={pain.title}
                className="hover-lift rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6 shadow-[0_18px_50px_rgba(0,0,0,0.08)]"
              >
