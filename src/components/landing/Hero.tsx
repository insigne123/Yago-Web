  ...
  return (
    <section id="inicio" className="relative overflow-hidden pb-20 pt-20 md:pb-24 md:pt-24 lg:pt-28">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[-7rem] top-[12%] h-[16rem] w-[16rem] rounded-full bg-white/5 blur-[92px]" />
      </div>
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Button
              asChild
              size="lg"
              className="group rounded-full border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(241,247,255,0.94))] px-6 text-slate-950 shadow-[0_14px_38px_rgba(5,11,19,0.24)] transition-transform hover:-translate-y-0.5 plausible-event-name=CTA+Agendar+Sesion plausible-event-location=hero"
            >
