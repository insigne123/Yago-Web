      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <div className="hover-lift rounded-3xl border border-slate-900/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(246,250,254,1))] p-2 md:p-4">
              <Accordion type="single" collapsible className="w-full">
                {FAQ_ITEMS.slice(0, 6).map((item, idx) => (
                  <AccordionItem key={idx} value={`item-${idx}`} className="border-slate-900/10">
