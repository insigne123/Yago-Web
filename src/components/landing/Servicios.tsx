  ...
  return (
    <Section id="servicios" className="z-10">
      <div className="mx-auto max-w-7xl px-4">
        <p className="text-xs tracking-[0.22em] text-sky-300/80">SERVICIOS</p>
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <Link
            href="/servicios"
            className="inline-flex items-center gap-2 text-sm font-medium text-sky-300 transition hover:text-sky-300"
          >
