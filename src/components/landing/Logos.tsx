  ...
  return (
    <Section className="pt-0" id="confianza">
      <div className="mx-auto max-w-7xl px-4">
        <div className="hover-lift overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,0.08)] md:px-8">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {COLABORADORES.slice(0, 2).map((colab) => (
                  <a
                    ...
                    className="rounded-[1.6rem] border border-white/10 bg-white/[0.06] px-6 py-5 shadow-[0_14px_34px_rgba(0,0,0,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(0,0,0,0.08)]"
                  >
            ...
            <div className="rounded-[1.8rem] border border-white/10 bg-white/5 p-5 md:p-6">
              ...
              <div className="mt-8 rounded-[1.6rem] border border-white/10 bg-white/[0.03] px-4 py-5 md:px-6">
                <div className="mb-4 text-center text-xs uppercase tracking-[0.18em] text-slate-300">
                ...
                <div className="grid grid-cols-2 gap-3 text-center sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
                  {items.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-white/10 bg-white/[0.04] px-3 py-3 text-sm font-medium text-white"
                    >
                      {item}
                    </div>
                  ))}
