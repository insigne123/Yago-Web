      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="mb-7 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs uppercase tracking-[0.22em] text-slate-300">Elige tu ruta</p>
          ...
          {routes.map((route) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-5 text-[11px] uppercase tracking-[0.18em] text-slate-400">{route.eyebrow}</div>
                <h3 className="mt-2 text-xl font-semibold leading-tight text-white">{route.title}</h3>
