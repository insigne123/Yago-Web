  ...
  return (
    <Section id="productos" className="z-10">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="absolute left-1/2 top-1/2 -z-10 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 opacity-20 blur-[120px] pointer-events-none">
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-emerald-500 via-cyan-500 to-fuchsia-500 mix-blend-screen" />
        </div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            {PRODUCTS.map((p) => {
              ...
              return (
                <div
                  key={p.slug}
                  className="group hover-lift relative flex flex-col overflow-hidden rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,37,0.72),rgba(10,16,25,0.9))] p-6 shadow-[0_18px_50px_rgba(0,0,0,0.12)] backdrop-blur-xl transition hover:border-white/14"
                >
