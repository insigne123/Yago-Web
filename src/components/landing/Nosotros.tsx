      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-12">
          <div className="md:col-span-7">
            <div className="hover-lift rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6 md:p-8">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div
                    key={x.t}
                    className="hover-lift rounded-2xl border border-white/10 bg-white/5 p-4"
                  >
            ...
            <div className="hover-lift rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6">
              ...
              <div className="mt-5 grid grid-cols-1 gap-3">
                {COLABORADORES.slice(0, 2).map((colab) => {
                  const Card = (
                    <div
                      className="flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.06] p-4 shadow-sm transition hover:shadow-md"
                    >
                      <Image
                        src={colab.logo}
